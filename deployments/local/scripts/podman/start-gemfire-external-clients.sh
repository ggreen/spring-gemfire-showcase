...
#$CR run -d  -e 'ACCEPT_TERMS=y' --rm --name gf-server1 --network=gemfire -p 40404:40404 gemfire/gemfire-all:10.1-jdk21 gfsh start server --name=server1 --locators=gf-locator\[10334\]
