...
wget -P runtime/apps  https://github.com/ggreenc/spring-gemfire-showcase/releases/download/GemFire-Spring-Workshop-v1/account-jdbc-caching-rest-service-1.0.0.jar
